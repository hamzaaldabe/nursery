...
egg_path = '/home/hamza/Desktop/hamza/ayahpi/project/baby_cry_detection/dist/baby_cry_detection-1.1-py3.11.egg'
...
def main():
    ...
    # Read signal
    file_name = 'recorded.wav'  # only one file in the folder
